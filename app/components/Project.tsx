  ...
  return (
    <div id="projects" className="w-full min-h-screen bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
        <h2 className="text-4xl lg:text-5xl lg:text-[70px] font-semibold text-[#2A363B] mb-12">Project Gallery</h2>
            ...
            >
              <div className={`relative w-full h-full ${image.aspectRatio}`}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <h3
                    className={`text-white text-xl font-semibold transform transition-all duration-300 ${
